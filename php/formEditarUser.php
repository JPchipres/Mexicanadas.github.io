    ...
    <div class="site-heading">
       <div class="margin"> <!-- Margin 5px y padding 5px -->
        ...
        <div class="container-sm">
          <div class="row">
          <form method="post" action="modificarUser.php" enctype="multipart/form-data">
            <div class="grid">  <!-- Columna -->             


              <div class="card text-dark bg-light mb-3 border border-secondary p-3 mb-5">
                <label for="" class="form-label">Nombre</label>
                <input type="text" class="form-control" name='name' id="name" value="<?php echo $sentencia_mostrar["autor"] ?>" required>
                <label for="" class="form-label">Correo electronico</label>
                <input type="email" class="form-control" name='mail' id="mail" value="<?php echo $sentencia_mostrar["email"] ?>" required>
                <label for="" class="form-label">Contraseña</label>
                <input type="password" class="form-control" name='pass' id="pass" required>
                <label for="" class="form-label">Confirmar contraseña</label>
                <input type="password" class="form-control" name='pass_confirm' id="pass_confirm" required>
                <input type="hidden" name="id" id="id" value="<?php echo $sentencia_mostrar['id']; ?>" />
                <br>
